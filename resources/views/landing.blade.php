...
<body class="landing-page">
    <header class="bg-transparent py-3">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="/" class="text-light fw-bold text-decoration-none header-link">سجل الان</a>
                <div></div>
            </div>
        </div>
    </header>
    ...
    <div class="container-fluid pt-3 pb-5 main-sec">
        <div class="first" style="background-image: url('{{ asset('images/bc.png') }}');"></div>
        <div class="container">
            <div class="row main-sec-row">
                <div class="col-md-6 text-center book-img">
                    <p class="page-content my-5">
                        **"مو عارف السوق وين رايح هالفترة؟ متردد وين تحط فلوسك وسط التذبذب اللي حاصل؟ لا تشيل هم، دام بيت الخبرة في ظهرك، استثماراتك في السليم!
                        <br/><br/>
                        القيمة العادلة مو مجرد رقم، هي المفتاح لاكتشاف الفرص الاستثمارية القوية في سوق الأسهم السعودية! قبل كذا، أوصينا بشراء سهم البحر الأحمر لما توقعنا ارتفاعه 200%—وبالفعل تحقق خلال 2024.
                ...
                <div class="col-md-6">
                    <h1 class="mb-4 font-bold page-title">سجل الان مجانا</h1>
                    @if(session('success'))
                        <div class="alert alert-success">{{ session('success') }}</div>
                    @endif
            ...
            <div class="row justify-content-center mt-5">
                ...
                <div class="col-md-4">
                    <div class="title text text-white text-center">القيمة العادلة لسعر سهم البحر الاحمر</div>
                    <img src="{{ asset('images/book.png') }}" alt="Placeholder Image" class="rounded">
                </div>
                <div class="col-md-4"></div>
            </div>
            {{-- <div class="row">
